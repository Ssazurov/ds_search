...
## NEXT SESSION
Epic #44 (news block) полностью закрыт (#45/#46/#48/#49/#61). Дальше —
смёржить PR #49 и PR issue-61 в main (порядок важен: #49 первым), затем
по желанию — включить cron в реальный crontab на сервере.
